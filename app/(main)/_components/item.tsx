  ...
  return (
    <div
      ...
      {isSearch && (
        <Tooltip
          content={
            <p className='z-[100000]'>
              Search and quickly jump to a potion{" "}
              <kbd
      ...
      {isSetting && (
        <Tooltip
          content={
            <p className='z-[100000]'>Change between light and dark mode</p>
          }
        />
      )}
      ...
      {isCreate && (
        <Tooltip
          content={<p className='z-[100000]'>Brew new potion from scratch</p>}
        />
      )}
